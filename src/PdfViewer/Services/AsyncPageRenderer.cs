...
public class AsyncPageRenderer
{
    ...
    /// </summary>
    public Task<System.Windows.Media.ImageSource?> GetVectorSurfaceAsync(int pageNumber, int rotationAngle, CancellationToken ct = default) =>
        _documentService.GetVectorPageSurfaceAsync(pageNumber, rotationAngle, ct);
